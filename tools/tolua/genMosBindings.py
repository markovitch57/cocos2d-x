...
def main():
    ...
    try:
        ...
        cmd_args = {'cocos2dx_mos.ini' : ('cocos2dx_mos', 'lua_cocos2dx_mos_auto')}
        ...
        for key in cmd_args.keys():
            ...
            _run_cmd(command)
            # _run_cmd(b'C:\\Python27\\python.exe c:\\dev\\cocos2d\\tools\\bindings-generator\\generator.py c:\\dev\\cocos2d\\tools\\cocos2dx_mos_ini')
            #  _run_cmd(b'C:\\Python27\\python.exe c:\\dev\\cocos2d\\tools\\bindings-generator\\generator.py c:\dev/cocos2d/tools/cocos2dx_mos_ini')
            #      C:\Python27\python.exe C:\dev\cocos2d\tools\bindings-generator/generator.py C:\dev\cocos2d/tools/tolua/cocos2dx_mos.ini -s cocos2dx_mos -t lua -o C:\dev\cocos2d/cocos/scripting/lua-bindings/auto -n lua_cocos2dx_mos_auto
        if platform == 'win32':
